...
# However, for damaged images or photos captured under highly sub-optimal conditions,
# a median blur can really help as a pre-processing step prior to passing the image along to other methods, such as thresholding and edge detection.
for k in (3, 9, 15):
